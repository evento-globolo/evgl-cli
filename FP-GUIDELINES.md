...
check was introduced: **12 findings across 2 files
and 299 lines**. CI compares against that budget and fails only when a
...
| `RS003` | 3 | error | typed errors | panic-based control flow (`unwrap`/`expect`/`panic!`) |
